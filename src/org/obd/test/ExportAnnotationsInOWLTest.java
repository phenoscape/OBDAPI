 ...
 *
 */
public class ExportAnnotationsInOWLTest extends AbstractOBDTest {
	
	
	public ExportAnnotationsInOWLTest(String n) {
		super(n);
	}
	...
	public void testWriteOWL() {
    	...
    	Collection<LinkStatement> statements = shard.getLinkStatementsByQuery(qt);
