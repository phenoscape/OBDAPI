    ...
    public Representation getRepresentation(Variant variant) {
        ...
        if (format.equals("json")) {
        	...
        	sb.append("Id:  ").append(href(node)).append('\n');
          	...
          	sb.append("Nodes: ").append(href(base+"/nodes",node.getId())).append("\n\n");
          	sb.append("Statements: ").append(href(base+"/statements",node.getId())).append("\n\n");
          	sb.append("Graph: ").append(href(base+"/graph",node.getId())).append("\n\n");
