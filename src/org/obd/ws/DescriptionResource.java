...
/**
 * Resource for a {@link CompositionalDescription}
 * 
 * @author cjm
 */
public class DescriptionResource extends NodeResource {
    ...
    public Representation getRepresentation(Variant variant) {
        ...
        // TODO: expose option for full traversal
         CompositionalDescription desc = 
        	 getShard().getCompositionalDescription(getNodeId(), false);
        ...
        if (format.equals("json")) {
    		...
    		result = new StringRepresentation(OBDXMLBridge.toXML(desc));
    		return result;
    	}
