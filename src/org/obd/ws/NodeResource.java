...
public class NodeResource extends OBDResource {
    ...
    public Node findNode() {
        ...
        if (nodeId != null) {       	
        	result = getShard().getNode(nodeId);    	
        }
    ...
    public Representation getRepresentation(Variant variant) {
    	...
    	if (format.equals("json")) {
    		...
    		sb.append("------------\n\n");
    		sb.append("Id:  ").append(href(node)).append('\n');
    		sb.append("Label: ").append(this.node.getLabel()).append("\n");
    		sb.append("Source: ").append(this.node.getSourceId()).append("\n\n");
    		sb.append("Statements: ").append(hrefStatementsFor(node.getId())).append("\n\n");
    		sb.append("Description: ").append(hrefDescriptionFor(node.getId())).append("\n\n");
    		sb.append("Graph: ").append(hrefGraph(node.getId())).append("\n\n");
           	sb.append(hrefToOtherFormats("/nodes/"+getNodeId()));
